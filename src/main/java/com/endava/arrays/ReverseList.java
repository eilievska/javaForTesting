...
public class ReverseList {
    ...
    public static void main(String[] args) {
        int[] array = new int[]{12, 4, 5, 2, 48};
        //reverseAnArray(array);
        reverseAnArrayInPlace(array);
    }

    public static int[] reverseAnArray(int[] inputArray) {
    ...
    public static void reverseAnArrayInPlace(int[] array) {
